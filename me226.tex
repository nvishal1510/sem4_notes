...
% 	- Gross blunders : The apparatus or instrument contruction invalidates the data, i.e, wrong construction.
% 	- Fixed errors : This will cause error to be shifted by a approximately same amount. This is called as bias error and systematic error. We can model these types of errors and correct the measured values.
% 	- Random erros : Human errors, random electronic fluctutations in instruments. This \emph{generally} (not always) a statistical distribution.
